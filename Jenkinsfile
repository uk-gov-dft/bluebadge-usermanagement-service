...
node {
    ...
    stage ('Gradle build') {
        ...
        try {
            sh './gradlew --refresh-dependencies --no-daemon --profile --configure-on-demand clean build bootJar createDatabaseSchemaZip artifactoryPublish artifactoryDeploy --refresh-dependencies'
