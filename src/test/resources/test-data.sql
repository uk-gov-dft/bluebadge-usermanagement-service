...
VALUES(-1, 'Sampath', 'abc@dft.gov.uk', 2, 2, '$2a$11$l8Y6fw6mOmj39naJfQtgvu1KITnSBDURsP7kCHWsJXthM.atfzNWC');
INSERT INTO users (id, name, email_address, local_authority_id, role_id, password)
VALUES(-2, 'Sampath', 'def@dft.gov.uk', 2, 2, '$2a$11$l8Y6fw6mOmj39naJfQtgvu1KITnSBDURsP7kCHWsJXthM.atfzNWC');
INSERT INTO users (id, name, email_address, local_authority_id, role_id, password)
